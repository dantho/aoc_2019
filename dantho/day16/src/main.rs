...
const BASE_REPEAT: usize = 10_000-3;

fn main() {

    println!("    5978783 Mod 650 is {}", 5978783 % 650);
    println!("EX5 0303673 Mod  32 is {}", 0303673 % 32);
    println!("EX6 0293510 Mod  32 is {}", 0293510 % 32); // 6 (is less than 8) -- This will be a problem until we implement the edge case
...
#[test]
fn test_part2_input() {
    assert_eq!(process(INPUT, 100), "xxxxxxxx".to_string()); // 26226606 is known to be wrong.  :(
}
#[test]
fn test_part2_ex5() {
